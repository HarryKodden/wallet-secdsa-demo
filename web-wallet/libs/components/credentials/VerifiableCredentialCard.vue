...
import {computed, defineProps, ref, toRef, watchEffect} from "vue";
...
const { jwtJson: credential, manifest, titleTitelized, isNotExpired, issuerName, issuerLogo } = useCredential(
    toRef(props, "credential") as any,
);
