    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
      ...
      >
        ...
        >
          ...
          <div class="mt-6 pt-6 flex flex-col h-full">
            <div class="space-y-1 px-2">
              <NuxtLink
                v-for="item in secondaryNavigation"
                :key="item.name"
...
import {ensureValidWallet, useCurrentWallet} from "@waltid-web-wallet/composables/accountWallet.ts";
...
// Recover from stale wallet deep links after wallet-api2 recreate / DB wipe
if (import.meta.client && currentWallet.value) {
  await ensureValidWallet();
}
