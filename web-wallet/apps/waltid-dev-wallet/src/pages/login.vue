        ...
        >
            ...
            >
                ...
                <div v-if="!isOidcLogin" class="mt-5">
                    <div class="mb-6 rounded-md bg-amber-50 p-3 text-sm text-amber-900">
                        SURF OIDC signs you in via classic <strong>wallet-api</strong>;
                        keys/credentials still use <strong>wallet-api2</strong>.
                    ...
                    <div class="relative my-4">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="bg-neutral-100/80 px-2 text-gray-500">or email</span>
                        </div>
                    </div>
